  ...
  return (
    <div className="w-full h-screen bg-[#F1F1F1] pt-1">
      <div className="textstructure mt-[12vw] px-14 flex flex-col">
        {["we creat", "eye opening", "presentation"].map((item, index) => {
          return (
            <div className="masker flex">
              {index === 1 && <div className="w-[9vw] h-[5.7vw] relative -top-[1.15vw] rounded-md mr-[1vw] bg-sky-300"></div>}
              <h1 className="uppercase  font-['Founders_Grotesk_X_Condensed'] text-[9vw] leading-[0.76] text-[#212121]  font-bold">{item}</h1>
            </div>
          );
        })}
      </div>
